...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it 'has password length less than 5 characters invalid' do
      user = User.new
      user.first_name = 'first_name'
      user.last_name = 'last_name'
    ...
    it 'has password length must be at-least 5 characters' do
      user = User.new
      user.first_name = 'first_name'
      user.last_name = 'last_name'
      user.email = 'test@test.com'
